...
window.onload = function(){
    ...
    async function callVisiterCollector() {
        console.log("collector go");
        let collect_data = "Yes";
        const body = `collect=${collect_data}`;
    
        url = '/php/dataCollector.php';
        options = {
            method : 'POST',
            body,
            headers: {
        ...
        console.log("collector end" + status);
    };
